...
const Links = () => {
  return (
    <div className="links-div">
      <a target="_blank" rel="noopener noreferrer" href='https://github.com/radbahi'>
      <Figure>
        <Figure.Image
          width={171}
          height={180}
      ...
      <a target="_blank" rel="noopener noreferrer" href='https://www.linkedin.com/in/radouane-bahi-5410a1137/'>
      <Figure>
        <Figure.Image
          width={171}
          height={180}
      ...
      <a target="_blank" rel="noopener noreferrer" href='https://medium.com/@radbahi'>
      <Figure>
        <Figure.Image
          width={171}
          height={180}
