...
import MemoriesImg from "../local_files/memoriesapp.png";
    ...
    <section className="project-section" id="project-section">
      ...
      <Carousel className="carousel" style={{ zIndex: "0" }}>
        <Carousel.Item>
          ...
          >
            <h1>Memories</h1>
            <p>A basic social media app</p>
            <a
              style={{ color: "#89CFF0" }}
              href="https://github.com/radbahi/memoriesbackend"
            >
              Backend
            </a>
            {" | "}
            <a
              style={{ color: "#89CFF0" }}
              href="https://github.com/radbahi/memories"
            >
              Frontend
            </a>
            {" | "}
            <a
              style={{ color: "#89CFF0" }}
              href="https://radbahi-memories.netlify.app/posts"
            >
              Website
            </a>
          </Carousel.Caption>
